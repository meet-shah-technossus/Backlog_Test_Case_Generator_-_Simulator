...
def get_phase8_integrity_report(*, run_id: str, run_repo: Agent3RunRepository) -> dict:
    ...
    for row in artifacts:
        ...
        if isinstance(artifact, dict) and artifact.get("artifact_type") == "phase6_execution_feedback":
